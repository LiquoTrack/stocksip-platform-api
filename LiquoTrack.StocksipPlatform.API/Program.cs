...
{
    throw new InvalidOperationException("MongoDB connection string and database name must be configured in appsettings.json");
}
...
// Register AppDbContext with the database name
builder.Services.AddScoped<AppDbContext>(sp => 
    new AppDbContext(sp.GetRequiredService<IMongoClient>(), databaseName));
